...
## TODOs
- See `docs/specs/TODO.md` for the consolidated feature and platform todo list.
...
- Track stats spec in `docs/specs/track-stats/track-stats-spec.md` updated to reflect completed implementation and resolved UX decisions.
...
- **Agent Definitions**: All specialized agent instruction files must be stored in `docs/agents/`.
- **Knowledge Sharing**: Specialized agents MUST record any useful discoveries, platform-specific quirks, or architectural lessons in their respective instruction files or "Major Lessons" in `agent.md` to benefit future agent instances.
- **Documentation**: General documentation should be in the `docs/` root.
